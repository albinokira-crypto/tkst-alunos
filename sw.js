const CACHE_NAME = 'tkst-alunos-v117';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=117',
  './assets/css/components.css?v=117',
  './assets/js/auth.js?v=117',
  './assets/js/data-curriculum.js?v=117',
  './assets/js/data-katas.js?v=117',
  './assets/js/data-kumite.js?v=117',
  './assets/js/data-glossary.js?v=117',
  './assets/js/data-quiz.js?v=117',
