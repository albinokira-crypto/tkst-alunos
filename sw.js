const CACHE_NAME = 'tkst-alunos-v20';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=20',
  './assets/css/components.css?v=20',
  './assets/js/auth.js?v=20',
  './assets/js/data-curriculum.js?v=20',
  './assets/js/data-katas.js?v=20',
  './assets/js/data-kumite.js?v=20',
  './assets/js/data-glossary.js?v=20',
  './assets/js/data-quiz.js?v=20',
