const CACHE_NAME = 'tkst-alunos-v123';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=123',
  './assets/css/components.css?v=123',
  './assets/js/auth.js?v=123',
  './assets/js/data-curriculum.js?v=123',
  './assets/js/data-katas.js?v=123',
  './assets/js/data-kumite.js?v=123',
  './assets/js/data-glossary.js?v=123',
  './assets/js/data-quiz.js?v=123',
