const CACHE_NAME = 'tkst-alunos-v76';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=76',
  './assets/css/components.css?v=76',
  './assets/js/auth.js?v=76',
  './assets/js/data-curriculum.js?v=76',
  './assets/js/data-katas.js?v=76',
  './assets/js/data-kumite.js?v=76',
  './assets/js/data-glossary.js?v=76',
  './assets/js/data-quiz.js?v=76',
