const CACHE_NAME = 'tkst-alunos-v94';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=94',
  './assets/css/components.css?v=94',
  './assets/js/auth.js?v=94',
  './assets/js/data-curriculum.js?v=94',
  './assets/js/data-katas.js?v=94',
  './assets/js/data-kumite.js?v=94',
  './assets/js/data-glossary.js?v=94',
  './assets/js/data-quiz.js?v=94',
