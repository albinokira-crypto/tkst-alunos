const CACHE_NAME = 'tkst-alunos-v61';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=61',
  './assets/css/components.css?v=61',
  './assets/js/auth.js?v=61',
  './assets/js/data-curriculum.js?v=61',
  './assets/js/data-katas.js?v=61',
  './assets/js/data-kumite.js?v=61',
  './assets/js/data-glossary.js?v=61',
  './assets/js/data-quiz.js?v=61',
