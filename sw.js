const CACHE_NAME = 'tkst-alunos-v90';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=90',
  './assets/css/components.css?v=90',
  './assets/js/auth.js?v=90',
  './assets/js/data-curriculum.js?v=90',
  './assets/js/data-katas.js?v=90',
  './assets/js/data-kumite.js?v=90',
  './assets/js/data-glossary.js?v=90',
  './assets/js/data-quiz.js?v=90',
