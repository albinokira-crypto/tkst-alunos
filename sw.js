const CACHE_NAME = 'tkst-alunos-v46';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=46',
  './assets/css/components.css?v=46',
  './assets/js/auth.js?v=46',
  './assets/js/data-curriculum.js?v=46',
  './assets/js/data-katas.js?v=46',
  './assets/js/data-kumite.js?v=46',
  './assets/js/data-glossary.js?v=46',
  './assets/js/data-quiz.js?v=46',
