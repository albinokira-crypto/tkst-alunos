const CACHE_NAME = 'tkst-alunos-v55';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=55',
  './assets/css/components.css?v=55',
  './assets/js/auth.js?v=55',
  './assets/js/data-curriculum.js?v=55',
  './assets/js/data-katas.js?v=55',
  './assets/js/data-kumite.js?v=55',
  './assets/js/data-glossary.js?v=55',
  './assets/js/data-quiz.js?v=55',
