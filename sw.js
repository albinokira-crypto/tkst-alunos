const CACHE_NAME = 'tkst-alunos-v38';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=38',
  './assets/css/components.css?v=38',
  './assets/js/auth.js?v=38',
  './assets/js/data-curriculum.js?v=38',
  './assets/js/data-katas.js?v=38',
  './assets/js/data-kumite.js?v=38',
  './assets/js/data-glossary.js?v=38',
  './assets/js/data-quiz.js?v=38',
