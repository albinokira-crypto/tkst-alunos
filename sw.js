const CACHE_NAME = 'tkst-alunos-v160';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=160',
  './assets/css/components.css?v=160',
  './assets/js/auth.js?v=160',
  './assets/js/data-curriculum.js?v=160',
  './assets/js/data-katas.js?v=160',
  './assets/js/data-kumite.js?v=160',
  './assets/js/data-glossary.js?v=160',
  './assets/js/data-quiz.js?v=160',
  './assets/js/data-exams.js?v=160',
  './assets/js/app.js?v=160',
