const CACHE_NAME = 'tkst-alunos-v75';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=75',
  './assets/css/components.css?v=75',
  './assets/js/auth.js?v=75',
  './assets/js/data-curriculum.js?v=75',
  './assets/js/data-katas.js?v=75',
  './assets/js/data-kumite.js?v=75',
  './assets/js/data-glossary.js?v=75',
  './assets/js/data-quiz.js?v=75',
