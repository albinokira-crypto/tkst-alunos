const CACHE_NAME = 'tkst-alunos-v62';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=62',
  './assets/css/components.css?v=62',
  './assets/js/auth.js?v=62',
  './assets/js/data-curriculum.js?v=62',
  './assets/js/data-katas.js?v=62',
  './assets/js/data-kumite.js?v=62',
  './assets/js/data-glossary.js?v=62',
  './assets/js/data-quiz.js?v=62',
