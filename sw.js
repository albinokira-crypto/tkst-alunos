const CACHE_NAME = 'tkst-alunos-v184';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=184',
  './assets/css/components.css?v=184',
  './assets/js/auth.js?v=184',
  './assets/js/data-curriculum.js?v=184',
  './assets/js/data-katas.js?v=184',
  './assets/js/data-kumite.js?v=184',
  './assets/js/data-glossary.js?v=184',
  './assets/js/data-quiz.js?v=184',
  './assets/js/data-exams.js?v=184',
