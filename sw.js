const CACHE_NAME = 'tkst-alunos-v64';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=64',
  './assets/css/components.css?v=64',
  './assets/js/auth.js?v=64',
  './assets/js/data-curriculum.js?v=64',
  './assets/js/data-katas.js?v=64',
  './assets/js/data-kumite.js?v=64',
  './assets/js/data-glossary.js?v=64',
  './assets/js/data-quiz.js?v=64',
