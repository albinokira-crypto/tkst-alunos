const CACHE_NAME = 'tkst-alunos-v68';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=68',
  './assets/css/components.css?v=68',
  './assets/js/auth.js?v=68',
  './assets/js/data-curriculum.js?v=68',
  './assets/js/data-katas.js?v=68',
  './assets/js/data-kumite.js?v=68',
  './assets/js/data-glossary.js?v=68',
  './assets/js/data-quiz.js?v=68',
