const CACHE_NAME = 'tkst-alunos-v115';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=115',
  './assets/css/components.css?v=115',
  './assets/js/auth.js?v=115',
  './assets/js/data-curriculum.js?v=115',
  './assets/js/data-katas.js?v=115',
  './assets/js/data-kumite.js?v=115',
  './assets/js/data-glossary.js?v=115',
  './assets/js/data-quiz.js?v=115',
