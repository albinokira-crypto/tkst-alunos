const CACHE_NAME = 'tkst-alunos-v180';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=180',
  './assets/css/components.css?v=180',
  './assets/js/auth.js?v=180',
  './assets/js/data-curriculum.js?v=180',
  './assets/js/data-katas.js?v=180',
  './assets/js/data-kumite.js?v=180',
  './assets/js/data-glossary.js?v=180',
  './assets/js/data-quiz.js?v=180',
  './assets/js/data-exams.js?v=180',
