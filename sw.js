const CACHE_NAME = 'tkst-alunos-v77';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=77',
  './assets/css/components.css?v=77',
  './assets/js/auth.js?v=77',
  './assets/js/data-curriculum.js?v=77',
  './assets/js/data-katas.js?v=77',
  './assets/js/data-kumite.js?v=77',
  './assets/js/data-glossary.js?v=77',
  './assets/js/data-quiz.js?v=77',
