const CACHE_NAME = 'tkst-alunos-v42';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=42',
  './assets/css/components.css?v=42',
  './assets/js/auth.js?v=42',
  './assets/js/data-curriculum.js?v=42',
  './assets/js/data-katas.js?v=42',
  './assets/js/data-kumite.js?v=42',
  './assets/js/data-glossary.js?v=42',
  './assets/js/data-quiz.js?v=42',
