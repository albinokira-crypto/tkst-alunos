const CACHE_NAME = 'tkst-alunos-v88';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=88',
  './assets/css/components.css?v=88',
  './assets/js/auth.js?v=88',
  './assets/js/data-curriculum.js?v=88',
  './assets/js/data-katas.js?v=88',
  './assets/js/data-kumite.js?v=88',
  './assets/js/data-glossary.js?v=88',
  './assets/js/data-quiz.js?v=88',
