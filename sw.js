const CACHE_NAME = 'tkst-alunos-v131';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=131',
  './assets/css/components.css?v=131',
  './assets/js/auth.js?v=131',
  './assets/js/data-curriculum.js?v=131',
  './assets/js/data-katas.js?v=131',
  './assets/js/data-kumite.js?v=131',
  './assets/js/data-glossary.js?v=131',
  './assets/js/data-quiz.js?v=131',
