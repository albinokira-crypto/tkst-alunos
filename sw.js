const CACHE_NAME = 'tkst-alunos-v138';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=138',
  './assets/css/components.css?v=138',
  './assets/js/auth.js?v=138',
  './assets/js/data-curriculum.js?v=138',
  './assets/js/data-katas.js?v=138',
  './assets/js/data-kumite.js?v=138',
  './assets/js/data-glossary.js?v=138',
  './assets/js/data-quiz.js?v=138',
