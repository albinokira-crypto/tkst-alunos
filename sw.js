const CACHE_NAME = 'tkst-alunos-v125';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=125',
  './assets/css/components.css?v=125',
  './assets/js/auth.js?v=125',
  './assets/js/data-curriculum.js?v=125',
  './assets/js/data-katas.js?v=125',
  './assets/js/data-kumite.js?v=125',
  './assets/js/data-glossary.js?v=125',
  './assets/js/data-quiz.js?v=125',
