const CACHE_NAME = 'tkst-alunos-v120';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=120',
  './assets/css/components.css?v=120',
  './assets/js/auth.js?v=120',
  './assets/js/data-curriculum.js?v=120',
  './assets/js/data-katas.js?v=120',
  './assets/js/data-kumite.js?v=120',
  './assets/js/data-glossary.js?v=120',
  './assets/js/data-quiz.js?v=120',
