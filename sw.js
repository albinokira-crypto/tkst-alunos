const CACHE_NAME = 'tkst-alunos-v137';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=137',
  './assets/css/components.css?v=137',
  './assets/js/auth.js?v=137',
  './assets/js/data-curriculum.js?v=137',
  './assets/js/data-katas.js?v=137',
  './assets/js/data-kumite.js?v=137',
  './assets/js/data-glossary.js?v=137',
  './assets/js/data-quiz.js?v=137',
  './assets/js/app.js?v=137',
