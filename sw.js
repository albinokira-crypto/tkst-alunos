const CACHE_NAME = 'tkst-alunos-v29';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=29',
  './assets/css/components.css?v=29',
  './assets/js/auth.js?v=29',
  './assets/js/data-curriculum.js?v=29',
  './assets/js/data-katas.js?v=29',
  './assets/js/data-kumite.js?v=29',
  './assets/js/data-glossary.js?v=29',
  './assets/js/data-quiz.js?v=29',
