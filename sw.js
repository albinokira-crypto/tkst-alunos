const CACHE_NAME = 'tkst-alunos-v118';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=118',
  './assets/css/components.css?v=118',
  './assets/js/auth.js?v=118',
  './assets/js/data-curriculum.js?v=118',
  './assets/js/data-katas.js?v=118',
  './assets/js/data-kumite.js?v=118',
  './assets/js/data-glossary.js?v=118',
  './assets/js/data-quiz.js?v=118',
