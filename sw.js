const CACHE_NAME = 'tkst-alunos-v67';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=67',
  './assets/css/components.css?v=67',
  './assets/js/auth.js?v=67',
  './assets/js/data-curriculum.js?v=67',
  './assets/js/data-katas.js?v=67',
  './assets/js/data-kumite.js?v=67',
  './assets/js/data-glossary.js?v=67',
  './assets/js/data-quiz.js?v=67',
