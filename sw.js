const CACHE_NAME = 'tkst-alunos-v122';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=122',
  './assets/css/components.css?v=122',
  './assets/js/auth.js?v=122',
  './assets/js/data-curriculum.js?v=122',
  './assets/js/data-katas.js?v=122',
  './assets/js/data-kumite.js?v=122',
  './assets/js/data-glossary.js?v=122',
  './assets/js/data-quiz.js?v=122',
