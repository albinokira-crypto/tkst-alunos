const CACHE_NAME = 'tkst-alunos-v54';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=54',
  './assets/css/components.css?v=54',
  './assets/js/auth.js?v=54',
  './assets/js/data-curriculum.js?v=54',
  './assets/js/data-katas.js?v=54',
  './assets/js/data-kumite.js?v=54',
  './assets/js/data-glossary.js?v=54',
  './assets/js/data-quiz.js?v=54',
