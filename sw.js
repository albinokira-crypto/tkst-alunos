const CACHE_NAME = 'tkst-alunos-v129';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=129',
  './assets/css/components.css?v=129',
  './assets/js/auth.js?v=129',
  './assets/js/data-curriculum.js?v=129',
  './assets/js/data-katas.js?v=129',
  './assets/js/data-kumite.js?v=129',
  './assets/js/data-glossary.js?v=129',
  './assets/js/data-quiz.js?v=129',
