const CACHE_NAME = 'tkst-alunos-v175';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=175',
  './assets/css/components.css?v=175',
  './assets/js/auth.js?v=175',
  './assets/js/data-curriculum.js?v=175',
  './assets/js/data-katas.js?v=175',
  './assets/js/data-kumite.js?v=175',
  './assets/js/data-glossary.js?v=175',
  './assets/js/data-quiz.js?v=175',
  './assets/js/data-exams.js?v=175',
  './assets/js/app.js?v=175',
