const CACHE_NAME = 'tkst-alunos-v133';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=133',
  './assets/css/components.css?v=133',
  './assets/js/auth.js?v=133',
  './assets/js/data-curriculum.js?v=133',
  './assets/js/data-katas.js?v=133',
  './assets/js/data-kumite.js?v=133',
  './assets/js/data-glossary.js?v=133',
  './assets/js/data-quiz.js?v=133',
