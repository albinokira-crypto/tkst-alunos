const CACHE_NAME = 'tkst-alunos-v97';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=97',
  './assets/css/components.css?v=97',
  './assets/js/auth.js?v=97',
  './assets/js/data-curriculum.js?v=97',
  './assets/js/data-katas.js?v=97',
  './assets/js/data-kumite.js?v=97',
  './assets/js/data-glossary.js?v=97',
  './assets/js/data-quiz.js?v=97',
