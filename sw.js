const CACHE_NAME = 'tkst-alunos-v93';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=93',
  './assets/css/components.css?v=93',
  './assets/js/auth.js?v=93',
  './assets/js/data-curriculum.js?v=93',
  './assets/js/data-katas.js?v=93',
  './assets/js/data-kumite.js?v=93',
  './assets/js/data-glossary.js?v=93',
  './assets/js/data-quiz.js?v=93',
