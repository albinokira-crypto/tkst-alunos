const CACHE_NAME = 'tkst-alunos-v45';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=45',
  './assets/css/components.css?v=45',
  './assets/js/auth.js?v=45',
  './assets/js/data-curriculum.js?v=45',
  './assets/js/data-katas.js?v=45',
  './assets/js/data-kumite.js?v=45',
  './assets/js/data-glossary.js?v=45',
  './assets/js/data-quiz.js?v=45',
