const CACHE_NAME = 'tkst-alunos-v100';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=100',
  './assets/css/components.css?v=100',
  './assets/js/auth.js?v=100',
  './assets/js/data-curriculum.js?v=100',
  './assets/js/data-katas.js?v=100',
  './assets/js/data-kumite.js?v=100',
  './assets/js/data-glossary.js?v=100',
  './assets/js/data-quiz.js?v=100',
