const CACHE_NAME = 'tkst-alunos-v65';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=65',
  './assets/css/components.css?v=65',
  './assets/js/auth.js?v=65',
  './assets/js/data-curriculum.js?v=65',
  './assets/js/data-katas.js?v=65',
  './assets/js/data-kumite.js?v=65',
  './assets/js/data-glossary.js?v=65',
  './assets/js/data-quiz.js?v=65',
