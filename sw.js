const CACHE_NAME = 'tkst-alunos-v43';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=43',
  './assets/css/components.css?v=43',
  './assets/js/auth.js?v=43',
  './assets/js/data-curriculum.js?v=43',
  './assets/js/data-katas.js?v=43',
  './assets/js/data-kumite.js?v=43',
  './assets/js/data-glossary.js?v=43',
  './assets/js/data-quiz.js?v=43',
