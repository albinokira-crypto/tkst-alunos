const CACHE_NAME = 'tkst-alunos-v69';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=69',
  './assets/css/components.css?v=69',
  './assets/js/auth.js?v=69',
  './assets/js/data-curriculum.js?v=69',
  './assets/js/data-katas.js?v=69',
  './assets/js/data-kumite.js?v=69',
  './assets/js/data-glossary.js?v=69',
  './assets/js/data-quiz.js?v=69',
