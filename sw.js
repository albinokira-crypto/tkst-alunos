const CACHE_NAME = 'tkst-alunos-v132';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=132',
  './assets/css/components.css?v=132',
  './assets/js/auth.js?v=132',
  './assets/js/data-curriculum.js?v=132',
  './assets/js/data-katas.js?v=132',
  './assets/js/data-kumite.js?v=132',
  './assets/js/data-glossary.js?v=132',
  './assets/js/data-quiz.js?v=132',
