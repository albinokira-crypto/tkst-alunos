const CACHE_NAME = 'tkst-alunos-v32';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=32',
  './assets/css/components.css?v=32',
  './assets/js/auth.js?v=32',
  './assets/js/data-curriculum.js?v=32',
  './assets/js/data-katas.js?v=32',
  './assets/js/data-kumite.js?v=32',
  './assets/js/data-glossary.js?v=32',
  './assets/js/data-quiz.js?v=32',
