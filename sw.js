const CACHE_NAME = 'tkst-alunos-v31';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=31',
  './assets/css/components.css?v=31',
  './assets/js/auth.js?v=31',
  './assets/js/data-curriculum.js?v=31',
  './assets/js/data-katas.js?v=31',
  './assets/js/data-kumite.js?v=31',
  './assets/js/data-glossary.js?v=31',
  './assets/js/data-quiz.js?v=31',
