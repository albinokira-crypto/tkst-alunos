const CACHE_NAME = 'tkst-alunos-v116';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=116',
  './assets/css/components.css?v=116',
  './assets/js/auth.js?v=116',
  './assets/js/data-curriculum.js?v=116',
  './assets/js/data-katas.js?v=116',
  './assets/js/data-kumite.js?v=116',
  './assets/js/data-glossary.js?v=116',
  './assets/js/data-quiz.js?v=116',
