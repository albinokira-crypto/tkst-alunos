const CACHE_NAME = 'tkst-alunos-v36';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=36',
  './assets/css/components.css?v=36',
  './assets/js/auth.js?v=36',
  './assets/js/data-curriculum.js?v=36',
  './assets/js/data-katas.js?v=36',
  './assets/js/data-kumite.js?v=36',
  './assets/js/data-glossary.js?v=36',
  './assets/js/data-quiz.js?v=36',
