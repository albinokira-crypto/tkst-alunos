const CACHE_NAME = 'tkst-alunos-v52';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=52',
  './assets/css/components.css?v=52',
  './assets/js/auth.js?v=52',
  './assets/js/data-curriculum.js?v=52',
  './assets/js/data-katas.js?v=52',
  './assets/js/data-kumite.js?v=52',
  './assets/js/data-glossary.js?v=52',
  './assets/js/data-quiz.js?v=52',
