const CACHE_NAME = 'tkst-alunos-v99';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=99',
  './assets/css/components.css?v=99',
  './assets/js/auth.js?v=99',
  './assets/js/data-curriculum.js?v=99',
  './assets/js/data-katas.js?v=99',
  './assets/js/data-kumite.js?v=99',
  './assets/js/data-glossary.js?v=99',
  './assets/js/data-quiz.js?v=99',
