const CACHE_NAME = 'tkst-alunos-v136';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=136',
  './assets/css/components.css?v=136',
  './assets/js/auth.js?v=136',
  './assets/js/data-curriculum.js?v=136',
  './assets/js/data-katas.js?v=136',
  './assets/js/data-kumite.js?v=136',
  './assets/js/data-glossary.js?v=136',
  './assets/js/data-quiz.js?v=136',
