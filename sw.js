const CACHE_NAME = 'tkst-alunos-v168';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=168',
  './assets/css/components.css?v=168',
  './assets/js/auth.js?v=168',
  './assets/js/data-curriculum.js?v=168',
  './assets/js/data-katas.js?v=168',
  './assets/js/data-kumite.js?v=168',
  './assets/js/data-glossary.js?v=168',
  './assets/js/data-quiz.js?v=168',
  './assets/js/data-exams.js?v=168',
  './assets/js/app.js?v=168',
