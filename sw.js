const CACHE_NAME = 'tkst-alunos-v70';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=70',
  './assets/css/components.css?v=70',
  './assets/js/auth.js?v=70',
  './assets/js/data-curriculum.js?v=70',
  './assets/js/data-katas.js?v=70',
  './assets/js/data-kumite.js?v=70',
  './assets/js/data-glossary.js?v=70',
  './assets/js/data-quiz.js?v=70',
