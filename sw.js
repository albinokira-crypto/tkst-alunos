const CACHE_NAME = 'tkst-alunos-v96';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=96',
  './assets/css/components.css?v=96',
  './assets/js/auth.js?v=96',
  './assets/js/data-curriculum.js?v=96',
  './assets/js/data-katas.js?v=96',
  './assets/js/data-kumite.js?v=96',
  './assets/js/data-glossary.js?v=96',
  './assets/js/data-quiz.js?v=96',
