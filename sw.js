const CACHE_NAME = 'tkst-alunos-v192';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=192',
  './assets/css/components.css?v=192',
  './assets/js/auth.js?v=192',
  './assets/js/data-curriculum.js?v=192',
  './assets/js/data-katas.js?v=192',
  './assets/js/data-kumite.js?v=192',
  './assets/js/data-glossary.js?v=192',
  './assets/js/data-quiz.js?v=192',
  './assets/js/data-exams.js?v=192',
  './assets/js/data-media.js?v=192',
