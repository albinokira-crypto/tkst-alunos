const CACHE_NAME = 'tkst-alunos-v101';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=101',
  './assets/css/components.css?v=101',
  './assets/js/auth.js?v=101',
  './assets/js/data-curriculum.js?v=101',
  './assets/js/data-katas.js?v=101',
  './assets/js/data-kumite.js?v=101',
  './assets/js/data-glossary.js?v=101',
  './assets/js/data-quiz.js?v=101',
