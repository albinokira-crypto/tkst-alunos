const CACHE_NAME = 'tkst-alunos-v169';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=169',
  './assets/css/components.css?v=169',
  './assets/js/auth.js?v=169',
  './assets/js/data-curriculum.js?v=169',
  './assets/js/data-katas.js?v=169',
  './assets/js/data-kumite.js?v=169',
  './assets/js/data-glossary.js?v=169',
  './assets/js/data-quiz.js?v=169',
  './assets/js/data-exams.js?v=169',
  './assets/js/app.js?v=169',
