const CACHE_NAME = 'tkst-alunos-v40';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=40',
  './assets/css/components.css?v=40',
  './assets/js/auth.js?v=40',
  './assets/js/data-curriculum.js?v=40',
  './assets/js/data-katas.js?v=40',
  './assets/js/data-kumite.js?v=40',
  './assets/js/data-glossary.js?v=40',
  './assets/js/data-quiz.js?v=40',
