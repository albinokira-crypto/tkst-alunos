const CACHE_NAME = 'tkst-alunos-v87';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=87',
  './assets/css/components.css?v=87',
  './assets/js/auth.js?v=87',
  './assets/js/data-curriculum.js?v=87',
  './assets/js/data-katas.js?v=87',
  './assets/js/data-kumite.js?v=87',
  './assets/js/data-glossary.js?v=87',
  './assets/js/data-quiz.js?v=87',
