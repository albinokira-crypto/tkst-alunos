const CACHE_NAME = 'tkst-alunos-v186';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=186',
  './assets/css/components.css?v=186',
  './assets/js/auth.js?v=186',
  './assets/js/data-curriculum.js?v=186',
  './assets/js/data-katas.js?v=186',
  './assets/js/data-kumite.js?v=186',
  './assets/js/data-glossary.js?v=186',
  './assets/js/data-quiz.js?v=186',
  './assets/js/data-exams.js?v=186',
  './assets/js/app.js?v=186',
