const CACHE_NAME = 'tkst-alunos-v119';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=119',
  './assets/css/components.css?v=119',
  './assets/js/auth.js?v=119',
  './assets/js/data-curriculum.js?v=119',
  './assets/js/data-katas.js?v=119',
  './assets/js/data-kumite.js?v=119',
  './assets/js/data-glossary.js?v=119',
  './assets/js/data-quiz.js?v=119',
