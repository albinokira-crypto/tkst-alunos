const CACHE_NAME = 'tkst-alunos-v22';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=22',
  './assets/css/components.css?v=22',
  './assets/js/auth.js?v=22',
  './assets/js/data-curriculum.js?v=22',
  './assets/js/data-katas.js?v=22',
  './assets/js/data-kumite.js?v=22',
  './assets/js/data-glossary.js?v=22',
  './assets/js/data-quiz.js?v=22',
