const CACHE_NAME = 'tkst-alunos-v41';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=41',
  './assets/css/components.css?v=41',
  './assets/js/auth.js?v=41',
  './assets/js/data-curriculum.js?v=41',
  './assets/js/data-katas.js?v=41',
  './assets/js/data-kumite.js?v=41',
  './assets/js/data-glossary.js?v=41',
  './assets/js/data-quiz.js?v=41',
