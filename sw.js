const CACHE_NAME = 'tkst-alunos-v34';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=34',
  './assets/css/components.css?v=34',
  './assets/js/auth.js?v=34',
  './assets/js/data-curriculum.js?v=34',
  './assets/js/data-katas.js?v=34',
  './assets/js/data-kumite.js?v=34',
  './assets/js/data-glossary.js?v=34',
  './assets/js/data-quiz.js?v=34',
