const CACHE_NAME = 'tkst-alunos-v135';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=135',
  './assets/css/components.css?v=135',
  './assets/js/auth.js?v=135',
  './assets/js/data-curriculum.js?v=135',
  './assets/js/data-katas.js?v=135',
  './assets/js/data-kumite.js?v=135',
  './assets/js/data-glossary.js?v=135',
  './assets/js/data-quiz.js?v=135',
