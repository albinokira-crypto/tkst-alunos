const CACHE_NAME = 'tkst-alunos-v98';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=98',
  './assets/css/components.css?v=98',
  './assets/js/auth.js?v=98',
  './assets/js/data-curriculum.js?v=98',
  './assets/js/data-katas.js?v=98',
  './assets/js/data-kumite.js?v=98',
  './assets/js/data-glossary.js?v=98',
  './assets/js/data-quiz.js?v=98',
  './assets/js/app.js?v=98',
