const CACHE_NAME = 'tkst-alunos-v124';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=124',
  './assets/css/components.css?v=124',
  './assets/js/auth.js?v=124',
  './assets/js/data-curriculum.js?v=124',
  './assets/js/data-katas.js?v=124',
  './assets/js/data-kumite.js?v=124',
  './assets/js/data-glossary.js?v=124',
  './assets/js/data-quiz.js?v=124',
