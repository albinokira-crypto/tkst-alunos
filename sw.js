const CACHE_NAME = 'tkst-alunos-v35';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=35',
  './assets/css/components.css?v=35',
  './assets/js/auth.js?v=35',
  './assets/js/data-curriculum.js?v=35',
  './assets/js/data-katas.js?v=35',
  './assets/js/data-kumite.js?v=35',
  './assets/js/data-glossary.js?v=35',
  './assets/js/data-quiz.js?v=35',
