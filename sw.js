const CACHE_NAME = 'tkst-alunos-v139';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=139',
  './assets/css/components.css?v=139',
  './assets/js/auth.js?v=139',
  './assets/js/data-curriculum.js?v=139',
  './assets/js/data-katas.js?v=139',
  './assets/js/data-kumite.js?v=139',
  './assets/js/data-glossary.js?v=139',
  './assets/js/data-quiz.js?v=139',
