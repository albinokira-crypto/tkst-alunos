const CACHE_NAME = 'tkst-alunos-v63';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=63',
  './assets/css/components.css?v=63',
  './assets/js/auth.js?v=63',
  './assets/js/data-curriculum.js?v=63',
  './assets/js/data-katas.js?v=63',
  './assets/js/data-kumite.js?v=63',
  './assets/js/data-glossary.js?v=63',
  './assets/js/data-quiz.js?v=63',
