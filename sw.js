const CACHE_NAME = 'tkst-alunos-v24';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=24',
  './assets/css/components.css?v=24',
  './assets/js/auth.js?v=24',
  './assets/js/data-curriculum.js?v=24',
  './assets/js/data-katas.js?v=24',
  './assets/js/data-kumite.js?v=24',
  './assets/js/data-glossary.js?v=24',
  './assets/js/data-quiz.js?v=24',
