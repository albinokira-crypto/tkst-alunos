const CACHE_NAME = 'tkst-alunos-v53';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=53',
  './assets/css/components.css?v=53',
  './assets/js/auth.js?v=53',
  './assets/js/data-curriculum.js?v=53',
  './assets/js/data-katas.js?v=53',
  './assets/js/data-kumite.js?v=53',
  './assets/js/data-glossary.js?v=53',
  './assets/js/data-quiz.js?v=53',
