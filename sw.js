const CACHE_NAME = 'tkst-alunos-v27';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=27',
  './assets/css/components.css?v=27',
  './assets/js/auth.js?v=27',
  './assets/js/data-curriculum.js?v=27',
  './assets/js/data-katas.js?v=27',
  './assets/js/data-kumite.js?v=27',
  './assets/js/data-glossary.js?v=27',
  './assets/js/data-quiz.js?v=27',
