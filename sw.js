const CACHE_NAME = 'tkst-alunos-v166';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=166',
  './assets/css/components.css?v=166',
  './assets/js/auth.js?v=166',
  './assets/js/data-curriculum.js?v=166',
  './assets/js/data-katas.js?v=166',
  './assets/js/data-kumite.js?v=166',
  './assets/js/data-glossary.js?v=166',
  './assets/js/data-quiz.js?v=166',
  './assets/js/data-exams.js?v=166',
