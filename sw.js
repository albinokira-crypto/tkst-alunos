const CACHE_NAME = 'tkst-alunos-v163';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=163',
  './assets/css/components.css?v=163',
  './assets/js/auth.js?v=163',
  './assets/js/data-curriculum.js?v=163',
  './assets/js/data-katas.js?v=163',
  './assets/js/data-kumite.js?v=163',
  './assets/js/data-glossary.js?v=163',
  './assets/js/data-quiz.js?v=163',
  './assets/js/data-exams.js?v=163',
  './assets/js/app.js?v=163',
