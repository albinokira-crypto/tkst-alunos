const CACHE_NAME = 'tkst-alunos-v121';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=121',
  './assets/css/components.css?v=121',
  './assets/js/auth.js?v=121',
  './assets/js/data-curriculum.js?v=121',
  './assets/js/data-katas.js?v=121',
  './assets/js/data-kumite.js?v=121',
  './assets/js/data-glossary.js?v=121',
  './assets/js/data-quiz.js?v=121',
