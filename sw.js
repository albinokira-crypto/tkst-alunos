const CACHE_NAME = 'tkst-alunos-v71';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=71',
  './assets/css/components.css?v=71',
  './assets/js/auth.js?v=71',
  './assets/js/data-curriculum.js?v=71',
  './assets/js/data-katas.js?v=71',
  './assets/js/data-kumite.js?v=71',
  './assets/js/data-glossary.js?v=71',
  './assets/js/data-quiz.js?v=71',
