const CACHE_NAME = 'tkst-alunos-v195';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=193',
  './assets/css/components.css?v=193',
  './assets/js/auth.js?v=195',
  './assets/js/data-curriculum.js?v=195',
  './assets/js/data-katas.js?v=195',
  './assets/js/data-kumite.js?v=195',
  './assets/js/data-glossary.js?v=195',
  './assets/js/data-quiz.js?v=195',
  './assets/js/data-exams.js?v=195',
  './assets/js/data-media.js?v=195',
  './assets/js/app.js?v=195',
