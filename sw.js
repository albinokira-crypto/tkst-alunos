const CACHE_NAME = 'tkst-alunos-v102';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=102',
  './assets/css/components.css?v=102',
  './assets/js/auth.js?v=102',
  './assets/js/data-curriculum.js?v=102',
  './assets/js/data-katas.js?v=102',
  './assets/js/data-kumite.js?v=102',
  './assets/js/data-glossary.js?v=102',
  './assets/js/data-quiz.js?v=102',
