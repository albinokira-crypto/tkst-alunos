const CACHE_NAME = 'tkst-alunos-v95';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=95',
  './assets/css/components.css?v=95',
  './assets/js/auth.js?v=95',
  './assets/js/data-curriculum.js?v=95',
  './assets/js/data-katas.js?v=95',
  './assets/js/data-kumite.js?v=95',
  './assets/js/data-glossary.js?v=95',
  './assets/js/data-quiz.js?v=95',
