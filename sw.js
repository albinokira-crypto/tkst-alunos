const CACHE_NAME = 'tkst-alunos-v23';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=23',
  './assets/css/components.css?v=23',
  './assets/js/auth.js?v=23',
  './assets/js/data-curriculum.js?v=23',
  './assets/js/data-katas.js?v=23',
  './assets/js/data-kumite.js?v=23',
  './assets/js/data-glossary.js?v=23',
  './assets/js/data-quiz.js?v=23',
