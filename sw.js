const CACHE_NAME = 'tkst-alunos-v92';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=92',
  './assets/css/components.css?v=92',
  './assets/js/auth.js?v=92',
  './assets/js/data-curriculum.js?v=92',
  './assets/js/data-katas.js?v=92',
  './assets/js/data-kumite.js?v=92',
  './assets/js/data-glossary.js?v=92',
  './assets/js/data-quiz.js?v=92',
