const CACHE_NAME = 'tkst-alunos-v57';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=57',
  './assets/css/components.css?v=57',
  './assets/js/auth.js?v=57',
  './assets/js/data-curriculum.js?v=57',
  './assets/js/data-katas.js?v=57',
  './assets/js/data-kumite.js?v=57',
  './assets/js/data-glossary.js?v=57',
  './assets/js/data-quiz.js?v=57',
