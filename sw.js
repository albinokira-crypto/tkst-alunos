const CACHE_NAME = 'tkst-alunos-v33';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=33',
  './assets/css/components.css?v=33',
  './assets/js/auth.js?v=33',
  './assets/js/data-curriculum.js?v=33',
  './assets/js/data-katas.js?v=33',
  './assets/js/data-kumite.js?v=33',
  './assets/js/data-glossary.js?v=33',
  './assets/js/data-quiz.js?v=33',
