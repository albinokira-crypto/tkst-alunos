const CACHE_NAME = 'tkst-alunos-v44';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=44',
  './assets/css/components.css?v=44',
  './assets/js/auth.js?v=44',
  './assets/js/data-curriculum.js?v=44',
  './assets/js/data-katas.js?v=44',
  './assets/js/data-kumite.js?v=44',
  './assets/js/data-glossary.js?v=44',
  './assets/js/data-quiz.js?v=44',
