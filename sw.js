const CACHE_NAME = 'tkst-alunos-v89';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=89',
  './assets/css/components.css?v=89',
  './assets/js/auth.js?v=89',
  './assets/js/data-curriculum.js?v=89',
  './assets/js/data-katas.js?v=89',
  './assets/js/data-kumite.js?v=89',
  './assets/js/data-glossary.js?v=89',
  './assets/js/data-quiz.js?v=89',
