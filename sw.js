const CACHE_NAME = 'tkst-alunos-v21';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=21',
  './assets/css/components.css?v=21',
  './assets/js/auth.js?v=21',
  './assets/js/data-curriculum.js?v=21',
  './assets/js/data-katas.js?v=21',
  './assets/js/data-kumite.js?v=21',
  './assets/js/data-glossary.js?v=21',
  './assets/js/data-quiz.js?v=21',
