const CACHE_NAME = 'tkst-alunos-v37';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=37',
  './assets/css/components.css?v=37',
  './assets/js/auth.js?v=37',
  './assets/js/data-curriculum.js?v=37',
  './assets/js/data-katas.js?v=37',
  './assets/js/data-kumite.js?v=37',
  './assets/js/data-glossary.js?v=37',
  './assets/js/data-quiz.js?v=37',
