const CACHE_NAME = 'tkst-alunos-v66';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=66',
  './assets/css/components.css?v=66',
  './assets/js/auth.js?v=66',
  './assets/js/data-curriculum.js?v=66',
  './assets/js/data-katas.js?v=66',
  './assets/js/data-kumite.js?v=66',
  './assets/js/data-glossary.js?v=66',
  './assets/js/data-quiz.js?v=66',
