const CACHE_NAME = 'tkst-alunos-v185';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=185',
  './assets/css/components.css?v=185',
  './assets/js/auth.js?v=185',
  './assets/js/data-curriculum.js?v=185',
  './assets/js/data-katas.js?v=185',
  './assets/js/data-kumite.js?v=185',
  './assets/js/data-glossary.js?v=185',
  './assets/js/data-quiz.js?v=185',
  './assets/js/data-exams.js?v=185',
  './assets/js/app.js?v=185',
