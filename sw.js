const CACHE_NAME = 'tkst-alunos-v26';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=26',
  './assets/css/components.css?v=26',
  './assets/js/auth.js?v=26',
  './assets/js/data-curriculum.js?v=26',
  './assets/js/data-katas.js?v=26',
  './assets/js/data-kumite.js?v=26',
  './assets/js/data-glossary.js?v=26',
  './assets/js/data-quiz.js?v=26',
