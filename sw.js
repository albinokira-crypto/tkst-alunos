const CACHE_NAME = 'tkst-alunos-v176';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=176',
  './assets/css/components.css?v=176',
  './assets/js/auth.js?v=176',
  './assets/js/data-curriculum.js?v=176',
  './assets/js/data-katas.js?v=176',
  './assets/js/data-kumite.js?v=176',
  './assets/js/data-glossary.js?v=176',
  './assets/js/data-quiz.js?v=176',
  './assets/js/data-exams.js?v=176',
