const CACHE_NAME = 'tkst-alunos-v28';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=28',
  './assets/css/components.css?v=28',
  './assets/js/auth.js?v=28',
  './assets/js/data-curriculum.js?v=28',
  './assets/js/data-katas.js?v=28',
  './assets/js/data-kumite.js?v=28',
  './assets/js/data-glossary.js?v=28',
  './assets/js/data-quiz.js?v=28',
