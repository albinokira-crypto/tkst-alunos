const CACHE_NAME = 'tkst-alunos-v80';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=80',
  './assets/css/components.css?v=80',
  './assets/js/auth.js?v=80',
  './assets/js/data-curriculum.js?v=80',
  './assets/js/data-katas.js?v=80',
  './assets/js/data-kumite.js?v=80',
  './assets/js/data-glossary.js?v=80',
  './assets/js/data-quiz.js?v=80',
