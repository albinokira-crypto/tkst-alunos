const CACHE_NAME = 'tkst-alunos-v177';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=177',
  './assets/css/components.css?v=177',
  './assets/js/auth.js?v=177',
  './assets/js/data-curriculum.js?v=177',
  './assets/js/data-katas.js?v=177',
  './assets/js/data-kumite.js?v=177',
  './assets/js/data-glossary.js?v=177',
  './assets/js/data-quiz.js?v=177',
  './assets/js/data-exams.js?v=177',
  './assets/js/app.js?v=177',
