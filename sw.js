const CACHE_NAME = 'tkst-alunos-v114';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=114',
  './assets/css/components.css?v=114',
  './assets/js/auth.js?v=114',
  './assets/js/data-curriculum.js?v=114',
  './assets/js/data-katas.js?v=114',
  './assets/js/data-kumite.js?v=114',
  './assets/js/data-glossary.js?v=114',
  './assets/js/data-quiz.js?v=114',
