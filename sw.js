const CACHE_NAME = 'tkst-alunos-v167';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=167',
  './assets/css/components.css?v=167',
  './assets/js/auth.js?v=167',
  './assets/js/data-curriculum.js?v=167',
  './assets/js/data-katas.js?v=167',
  './assets/js/data-kumite.js?v=167',
  './assets/js/data-glossary.js?v=167',
  './assets/js/data-quiz.js?v=167',
  './assets/js/data-exams.js?v=167',
  './assets/js/app.js?v=167',
