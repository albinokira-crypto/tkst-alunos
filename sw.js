const CACHE_NAME = 'tkst-alunos-v30';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=30',
  './assets/css/components.css?v=30',
  './assets/js/auth.js?v=30',
  './assets/js/data-curriculum.js?v=30',
  './assets/js/data-katas.js?v=30',
  './assets/js/data-kumite.js?v=30',
  './assets/js/data-glossary.js?v=30',
  './assets/js/data-quiz.js?v=30',
