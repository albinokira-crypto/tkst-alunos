const CACHE_NAME = 'tkst-alunos-v25';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=25',
  './assets/css/components.css?v=25',
  './assets/js/auth.js?v=25',
  './assets/js/data-curriculum.js?v=25',
  './assets/js/data-katas.js?v=25',
  './assets/js/data-kumite.js?v=25',
  './assets/js/data-glossary.js?v=25',
  './assets/js/data-quiz.js?v=25',
