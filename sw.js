const CACHE_NAME = 'tkst-alunos-v74';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=74',
  './assets/css/components.css?v=74',
  './assets/js/auth.js?v=74',
  './assets/js/data-curriculum.js?v=74',
  './assets/js/data-katas.js?v=74',
  './assets/js/data-kumite.js?v=74',
  './assets/js/data-glossary.js?v=74',
  './assets/js/data-quiz.js?v=74',
