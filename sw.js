const CACHE_NAME = 'tkst-alunos-v86';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=86',
  './assets/css/components.css?v=86',
  './assets/js/auth.js?v=86',
  './assets/js/data-curriculum.js?v=86',
  './assets/js/data-katas.js?v=86',
  './assets/js/data-kumite.js?v=86',
  './assets/js/data-glossary.js?v=86',
  './assets/js/data-quiz.js?v=86',
