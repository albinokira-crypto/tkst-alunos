const CACHE_NAME = 'tkst-alunos-v72';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=72',
  './assets/css/components.css?v=72',
  './assets/js/auth.js?v=72',
  './assets/js/data-curriculum.js?v=72',
  './assets/js/data-katas.js?v=72',
  './assets/js/data-kumite.js?v=72',
  './assets/js/data-glossary.js?v=72',
  './assets/js/data-quiz.js?v=72',
