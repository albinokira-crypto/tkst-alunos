const CACHE_NAME = 'tkst-alunos-v39';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=39',
  './assets/css/components.css?v=39',
  './assets/js/auth.js?v=39',
  './assets/js/data-curriculum.js?v=39',
  './assets/js/data-katas.js?v=39',
  './assets/js/data-kumite.js?v=39',
  './assets/js/data-glossary.js?v=39',
  './assets/js/data-quiz.js?v=39',
