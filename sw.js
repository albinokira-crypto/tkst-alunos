const CACHE_NAME = 'tkst-alunos-v126';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=126',
  './assets/css/components.css?v=126',
  './assets/js/auth.js?v=126',
  './assets/js/data-curriculum.js?v=126',
  './assets/js/data-katas.js?v=126',
  './assets/js/data-kumite.js?v=126',
  './assets/js/data-glossary.js?v=126',
  './assets/js/data-quiz.js?v=126',
