const CACHE_NAME = 'tkst-alunos-v60';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=60',
  './assets/css/components.css?v=60',
  './assets/js/auth.js?v=60',
  './assets/js/data-curriculum.js?v=60',
  './assets/js/data-katas.js?v=60',
  './assets/js/data-kumite.js?v=60',
  './assets/js/data-glossary.js?v=60',
  './assets/js/data-quiz.js?v=60',
