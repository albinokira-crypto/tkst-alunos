const CACHE_NAME = 'tkst-alunos-v79';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=79',
  './assets/css/components.css?v=79',
  './assets/js/auth.js?v=79',
  './assets/js/data-curriculum.js?v=79',
  './assets/js/data-katas.js?v=79',
  './assets/js/data-kumite.js?v=79',
  './assets/js/data-glossary.js?v=79',
  './assets/js/data-quiz.js?v=79',
