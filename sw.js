const CACHE_NAME = 'tkst-alunos-v73';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=73',
  './assets/css/components.css?v=73',
  './assets/js/auth.js?v=73',
  './assets/js/data-curriculum.js?v=73',
  './assets/js/data-katas.js?v=73',
  './assets/js/data-kumite.js?v=73',
  './assets/js/data-glossary.js?v=73',
  './assets/js/data-quiz.js?v=73',
