const CACHE_NAME = 'tkst-alunos-v56';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=56',
  './assets/css/components.css?v=56',
  './assets/js/auth.js?v=56',
  './assets/js/data-curriculum.js?v=56',
  './assets/js/data-katas.js?v=56',
  './assets/js/data-kumite.js?v=56',
  './assets/js/data-glossary.js?v=56',
  './assets/js/data-quiz.js?v=56',
