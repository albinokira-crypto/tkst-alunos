const CACHE_NAME = 'tkst-alunos-v159';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=159',
  './assets/css/components.css?v=159',
  './assets/js/auth.js?v=159',
  './assets/js/data-curriculum.js?v=159',
  './assets/js/data-katas.js?v=159',
  './assets/js/data-kumite.js?v=159',
  './assets/js/data-glossary.js?v=159',
  './assets/js/data-quiz.js?v=159',
  './assets/js/data-exams.js?v=159',
  './assets/js/app.js?v=159',
