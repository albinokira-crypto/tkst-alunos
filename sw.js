const CACHE_NAME = 'tkst-alunos-v156';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=156',
  './assets/css/components.css?v=156',
  './assets/js/auth.js?v=156',
  './assets/js/data-curriculum.js?v=156',
  './assets/js/data-katas.js?v=156',
  './assets/js/data-kumite.js?v=156',
  './assets/js/data-glossary.js?v=156',
  './assets/js/data-quiz.js?v=156',
  './assets/js/data-exams.js?v=156',
  './assets/js/app.js?v=156',
