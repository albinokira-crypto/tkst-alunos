const CACHE_NAME = 'tkst-alunos-v91';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=91',
  './assets/css/components.css?v=91',
  './assets/js/auth.js?v=91',
  './assets/js/data-curriculum.js?v=91',
  './assets/js/data-katas.js?v=91',
  './assets/js/data-kumite.js?v=91',
  './assets/js/data-glossary.js?v=91',
  './assets/js/data-quiz.js?v=91',
