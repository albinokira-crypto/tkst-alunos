const CACHE_NAME = 'tkst-alunos-v103';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './assets/css/main.css?v=103',
  './assets/css/components.css?v=103',
  './assets/js/auth.js?v=103',
  './assets/js/data-curriculum.js?v=103',
  './assets/js/data-katas.js?v=103',
  './assets/js/data-kumite.js?v=103',
  './assets/js/data-glossary.js?v=103',
  './assets/js/data-quiz.js?v=103',
